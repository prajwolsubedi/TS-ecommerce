...
import { useAppSelector, useAppDispatch } from "../../../assets/store";
import { ProductItem } from "../../../models/model";

const CategoryDropdown: React.FC<{ filterProducts: () => ProductItem[] }> = ({
  filterProducts,
}) => {
  const currCategory = useAppSelector((state) => state.product.category);
